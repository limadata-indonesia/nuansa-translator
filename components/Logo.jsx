// Wordmark recreated in the site style: "Nuansa Translator" with a lime globe
    ...
    <span className={`brand${light ? " brand--light" : ""}`}>
      ...
      <span className="brand__globe" aria-hidden="true">
        <svg viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="11" fill="#a3e635" />
          <g fill="none" stroke="#14331f" strokeWidth="1.5" strokeLinecap="round">
