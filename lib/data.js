...
export const SERVICES = [
  ...
  { n: "07", title: "Juru Bahasa Isyarat", desc: "Juru bahasa isyarat SIBI & BISINDO untuk acara, siaran, hukum, medis, dan pendidikan.", href: "/juru-bahasa-isyarat" },
  { n: "08", title: "Sewa Alat Interpreter", desc: "Booth, headset, tour guide, dan teknisi untuk konferensi simultan.", href: "/sewa-alat-interpreter" },
];

export const INDUSTRIES = ["Hukum", "Medis", "Keuangan", "Pemasaran & Periklanan", "Pemerintahan", "Teknologi Informasi", "Teknik", "Otomotif", "Energi, Minyak & Gas", "SDM", "Game", "Fesyen", "Kosmetik", "Korporat", "Akademik"];
